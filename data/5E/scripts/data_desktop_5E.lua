	...
	["local"] =
	{
		...
		},
		{
			...
			modules =
			{
				...
				{ name = "D&D Sword Coast Adventurer's Guide - Player's Guide", storeid = "WOTC5ESCAG", displayname = "D&D Sword Coast Adventurer's Guide - Player",  },
	...
	["host"] =
	{
		...
		},
		{
			...
			modules =
			{
				...
				{ name = "DD Mordenkainen's Tome of Foes Players", storeid = "WOTC5EMTOF", displayname = "D&D Mordenkainen's Tome of Foes - Player" },
				{ name = "D&D Sword Coast Adventurer's Guide - Campaign Guide", storeid = "WOTC5ESCAG", displayname = "D&D Sword Coast Adventurer's Guide" },
				{ name = "D&D Sword Coast Adventurer's Guide - Player's Guide", storeid = "WOTC5ESCAG", displayname = "D&D Sword Coast Adventurer's Guide - Player"  },
